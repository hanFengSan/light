...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private boolean mIsIndicatorLeft;
    ...
    private boolean mIsCustomMargin;
...
//                setMargin
                if (mIsCustomMargin) {
                    ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) tv_tab_title.getLayoutParams();
    ...
    private void calcIndicatorRect() {
        ...
        } else if (mIsIndicatorLeft) {
            float indicatorLeft = currentTabView.getLeft() + mTabPadding + 22;
...
//                        Log.e("debug", String.format("paddingLeft: %d, mIndicatorMarginLeft: %d, IndicatorRect.left: %d", paddingLeft, (int) mIndicatorMarginLeft, mIndicatorRect.left));
//                        Log.e("debug", String.format("paddingRight: %d, mIndicatorMarginRight: %d, IndicatorRect.Right: %d", paddingLeft, (int) mIndicatorMarginRight, mIndicatorRect.right));

//                        Log.e("debug", String.format("left: %d, top: %d, right: %d, bottom: %d",
//                                mIndicatorDrawable.getBounds().left,
//                                mIndicatorDrawable.getBounds().top,
//                                mIndicatorDrawable.getBounds().right,
//                                mIndicatorDrawable.getBounds().bottom));
                    } else {
                        mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                                height - (int) mIndicatorHeight - (int) mIndicatorMarginBottom,
                                paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight,
    ...
    public void setTabMargin(int left, int top, int right, int bottom) {
        mMarginTop = dp2px(top);
        mMarginRight = dp2px(right);
        mMarginBottom = dp2px(bottom);
        mMarginLeft = dp2px(left);
        mIsCustomMargin = true;
        updateTabStyles();
    }

    /**
     * put indicator to left of tab
     */
    public void setIndicatorLeft(boolean isLeft) {
        mIsIndicatorLeft = isLeft;
        updateTabStyles();
    }
}
