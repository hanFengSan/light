...
public class SlidingCommonTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    public SlidingCommonTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingCommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mValueAnimator = ValueAnimator.ofObject(new SlidingCommonTabLayout.PointEvaluator(), mLastP, mCurrentP);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        View currentTabView = mTabsContainer.getChildAt(this.mCurrentTab);
        CommonTabLayout.IndicatorPoint p = (CommonTabLayout.IndicatorPoint) animation.getAnimatedValue();
    ...
    private SlidingCommonTabLayout.IndicatorPoint mCurrentP = new SlidingCommonTabLayout.IndicatorPoint();
    private SlidingCommonTabLayout.IndicatorPoint mLastP = new SlidingCommonTabLayout.IndicatorPoint();

    class PointEvaluator implements TypeEvaluator<SlidingCommonTabLayout.IndicatorPoint> {
        @Override
        public SlidingCommonTabLayout.IndicatorPoint evaluate(float fraction, SlidingCommonTabLayout.IndicatorPoint startValue, SlidingCommonTabLayout.IndicatorPoint endValue) {
            float left = startValue.left + fraction * (endValue.left - startValue.left);
            float right = startValue.right + fraction * (endValue.right - startValue.right);
            SlidingCommonTabLayout.IndicatorPoint point = new SlidingCommonTabLayout.IndicatorPoint();
            point.left = left;
            point.right = right;
            return point;
        }
