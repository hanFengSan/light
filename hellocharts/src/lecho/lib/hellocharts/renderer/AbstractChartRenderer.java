...
import lecho.lib.hellocharts.util.YakamiUtils;
...
public abstract class AbstractChartRenderer implements ChartRenderer {
    ...
    protected void drawLabelTextAndBackground(Canvas canvas, char[] labelBuffer, int startIndex, int numChars,
        ...
        //YakamiBookmarks, 修正数值为正数
        if (YakamiUtils.isNegativeNUmber(labelBuffer)) {
            labelBuffer = YakamiUtils.toPositiveNumber(labelBuffer);
            canvas.drawText(labelBuffer, startIndex + 1, numChars - 1, textX, textY, labelPaint);
        } else
